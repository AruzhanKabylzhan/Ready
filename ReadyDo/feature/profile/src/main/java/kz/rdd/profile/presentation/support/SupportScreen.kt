...
fun SupportScreen(
    ...
    Column(
        ...
        Text(
            text = "Discover quick answers to all your questions about using ReadyDo, the ultimate homemade food app, on our FAQ Support Page. From ordering to safety tips, find everything you need for a seamless experience!",
